...
void diphotonRocComp(){
    ...
    string fOut[5];
    string outStrGen = "outROC/0504/GGH_TestComp_";
    fOut[0] = outStrGen + "BB";
    fOut[1] = outStrGen + "BE";
    fOut[2] = outStrGen + "EE";
    ...
    string fileName1;
    string f1Label = "Test Sample";
    fileName1 = "validationNTuples/0425/GGHandData_MD9LR10.root";
    
    string fileName2;
    string f2Label = "Validation Sample";
    fileName2 = "validationNTuples/0425/GGHandData_MD17LR05.root";
   ...
   //FOR FIRST ROC CURVE
    ...
    TTreeReader sigReader1("sigTree", f1);
    ...
    TTreeReader bkgReader1("bkgTree", f1);
    ...
    TTreeReader sigReader2("sigTree", f2);
    ...
    TTreeReader bkgReader2("bkgTree", f2);
