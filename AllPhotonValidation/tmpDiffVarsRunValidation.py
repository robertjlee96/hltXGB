...
import diffVarsValidationUtils
...
inFileName ="../../CMSSW_12_4_8/src/allPhotonsNTuples/GGH13andData0D_DiphotonValidation_JustGOLDEN_0801.root"
modelNamesB = []
modelNamesE = []
mNamesGen =  []
fNames = []
...
for mName in mNamesGen:
    ...
    #fNames.append("validationNTuples/" + mName + "_Data0D_JustMUON_Validated")
fNames.append("validationNTuples/0801/M9LR15_GGH13_NoTrkIso_M60_Data0D_JustGOLDEN_Validated")
...
inputValuesSig, inputValuesBkg, varValuesSig, varValuesBkg, inputVarNames, varNames, nEventsSig, nEventsBkg = diffVarsValidationUtils.load_file(inFileName,geometry_selection,ptCut)
...
#FIRST DO SIGNAL
    ...
    for n in range(0,nEventsSig):
        ...
        for m in range(0,nEgsSig[0]):
            ...
            etaSig[m] = varsSigTotal[photonIndexSig][6]
            hOvrESig[m] = varsSigTotal[photonIndexSig][7]
            ecalPFIsoSig[m] = varsSigTotal[photonIndexSig][8]
            trkIsoPhoSig[m] = varsSigTotal[photonIndexSig][9]
...
##NOW DO BACKGROUND
    ...
    for n in range(0,nEventsBkg):
        ...
        for m in range(0,nEgsBkg[0]):
            ...
            etaBkg[m] = varsBkgTotal[photonIndexBkg][6]
            hOvrEBkg[m] = varsBkgTotal[photonIndexBkg][7]
            ecalPFIsoBkg[m] = varsBkgTotal[photonIndexBkg][8]
            trkIsoPhoBkg[m] = varsBkgTotal[photonIndexBkg][9]
...
#modelNamesB.append("../Training/barrelOut/" + mNamesGen[1] + "_Barrel.model")
#modelNamesB.append("../Training/barrelOut/" + mNamesGen[2] + "_Barrel.model")
#modelNamesB.append("../Training/barrelOut/" + mNamesGen[3] + "_Barrel.model")
#modelNamesB.append("../Training/barrelOut/" + mNamesGen[4] + "_Barrel.model")
#modelNamesB.append("../Training/barrelOut/" + mNamesGen[5] + "_Barrel.model")
#modelNamesB.append("../Training/barrelOut/" + mNamesGen[5] + "_Barrel.model")
#modelNamesB.append("../Training/barrelOut/" + mNamesGen[5] + "_Barrel.model")
#modelNamesB.append("../Training/barrelOut/" + mNamesGen[5] + "_Barrel.model")
#modelNamesB.append("../Training/barrelOut/" + mNamesGen[5] + "_Barrel.model")
...
#modelNamesE.append("../Training/endcapOut/" + mNamesGen[1] + "_Endcap.model")
#modelNamesE.append("../Training/endcapOut/" + mNamesGen[2] + "_Endcap.model")
#modelNamesE.append("../Training/endcapOut/" + mNamesGen[3] + "_Endcap.model")
#modelNamesE.append("../Training/endcapOut/" + mNamesGen[4] + "_Endcap.model")
#modelNamesE.append("../Training/endcapOut/" + mNamesGen[5] + "_Endcap.model")
#modelNamesE.append("../Training/endcapOut/" + mNamesGen[5] + "_Endcap.model")
#modelNamesE.append("../Training/endcapOut/" + mNamesGen[5] + "_Endcap.model")
#modelNamesE.append("../Training/endcapOut/" + mNamesGen[5] + "_Endcap.model")
#modelNamesE.append("../Training/endcapOut/" + mNamesGen[5] + "_Endcap.model")
#
#
#fNames.append("validationNTuples/0725/GGH13andData_MD09LR07_NoTrkIso_Validated")
#fNames.append("validationNTuples/0725/GGH13andData_MD09LR1_NoTrkIso_Validated")
#fNames.append("validationNTuples/0725/GGH13andData_MD09LR13_NoTrkIso_Validated")
#fNames.append("validationNTuples/0725/GGH13andData_MD13LR07_NoTrkIso_Validated")
#fNames.append("validationNTuples/0725/GGH13andData_MD13LR1_NoTrkIso_Validated")
#fNames.append("validationNTuples/0725/GGH13andData_MD13LR13_NoTrkIso_Validated")
