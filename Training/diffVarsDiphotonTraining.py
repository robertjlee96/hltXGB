...
import diffVarsDiphotonUtils
from diffVarsDiphotonUtils import buildBranch
...
inputValuesSig, inputValuesBkg, targetValuesSigX, targetValuesBkgX, origWeightsSig, origWeightsBkg, varValuesSig, varValuesBkg, inputVarNames, varNames = diffVarsDiphotonUtils.loadFile(fin,geometry_selection,ptCut,massCut)
...
modelB = XGBClassifier(max_depth = mdB, learning_rate = lrB, scale_pos_weight = bkgToSig, subsample = 0.9, max_delta_step = MDS, min_child_weight = 0.0, reg_alpha = 0.0, reg_lambda = 4.0, colsample_bytree = 0.65, verbosity = 0, n_estimators=nEstB, nthread = 16, feature_names = inputVarNames)
...
modelE = XGBClassifier(max_depth = mdE, learning_rate = lrE, scale_pos_weight = bkgToSig, subsample = 0.9, max_delta_step = MDS, min_child_weight = 0.0, reg_alpha = 0.0, reg_lambda = 4.0, colsample_bytree = 0.65, verbosity = 0, n_estimators=nEstB, nthread = 16, feature_names = inputVarNames)
